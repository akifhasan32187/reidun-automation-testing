...
def perform_settings_iteration(iteration, currency_symbol_position_xpath, amount_format_xpath, date_format_xpath, time_format_xpath,
    ...
    print("Clicked on Company Settings.")
    ...
    print("Clicked on System Settings.")
    ...
    print(f"Selected Currency Symbol Position as ")
    ...
    amount_format_element.click()
    print(f"Selected Amount Format as '{amount_format_text}' ")
    ...
    print(f"Entered Currency as '{currency}'.")
    ...
    print(f"Entered Currency Symbol as '{currency_symbol}'.")
    ...
    print(f"Selected Date Format as '{date_format_text}'")
    ...
    print(f"Selected Time Format as '{time_format_text}'")
    ...
    print(f"Entered Outgoing Invoice Prefix as '{outgoing_invoice_prefix}'.")

    time.sleep(3)

    # Enter Outgoing Invoice Starting Number
    # Assuming this is fixed or needs no interaction
    print(f"Outgoing Invoice Starting Number is Fixed as '{outgoing_invoice_starting_number}'.")
    ...
    print(f"Entered Incoming Invoice Prefix as '{incoming_invoice_prefix}'.")

    time.sleep(3)

    # Enter Incoming Invoice Starting Number
    # Assuming this is fixed or needs no interaction
    print(f"Incoming Invoice Starting Number is Fixed as '{incoming_invoice_starting_number}'.")
    ...
    print(f"Entered Customer Prefix as '{customer_prefix}'.")
    ...
    print(f"Entered Supplier Prefix as '{supplier_prefix}'.")
    ...
    print(f"Entered Invoice/Bill Footer Notes as '{footer_notes}'.")
    ...
    time.sleep(1)  # Add a small delay to ensure the scroll completes
    save_changes.click()
...
perform_settings_iteration(5,
    '//*[@id="flexCheckDefault"]',  # Currency Symbol Position = 'Pre'
    '//*[@id="choices--amount_format-item-choice-1"]',  # Amount Format = '000 000 000,00'
    '//*[@id="site_date_format"]/option[5]',  # Date Format = 'dd/MM/yyyy'
    '//*[@id="site_time_format"]/option[2]',  # Time Format = '10:30 pm'
    'Rupee', '₹', 'A#@!!', '4564', 'YY^^&&', '5564', 'Aftab', 'Ryan', 'Sample'
)

# Closing the browser after all iterations
driver.quit()
